...
def datas(soup):
    ...
    with open(r'C:\Users\Naveen\Desktop\data science\data scrapping\Amazon data scraping project\CSV folder\page1.csv','w', newline='',encoding='UTF8')as f:
        writer=csv.writer(f)
    ...
    #header=['Product Name','Price','Rating','No of Reviews','ASIN','Manufacturer','URL']
        ...
        with open(r'C:\Users\Naveen\Desktop\data science\data scrapping\Amazon data scraping project\CSV folder\page1.csv','a+', newline='',encoding='UTF8')as f:
            writer=csv.writer(f)
