...
import time
s=HTMLSession()
url="https://www.amazon.in/s?k=bags&page=4&crid=2M096C61O4MLT&qid=1693203976&sprefix=ba%2Caps%2C283&ref=sr_pg_3"
header=['Product Name','Price','Rating','No of Reviews','ASIN','Manufacturer','URL']
with open(r'C:\Users\Naveen\Desktop\data science\data scrapping\Amazon data scraping project\CSV folder\page4.csv','w', newline='',encoding='UTF8')as f:
    writer=csv.writer(f)
...
def datas(soup):
    ...
    #header=['Product Name','Price','Rating','No of Reviews','ASIN','Manufacturer','URL']
        ...
        with open(r'C:\Users\Naveen\Desktop\data science\data scrapping\Amazon data scraping project\CSV folder\page4.csv','a+', newline='',encoding='UTF8')as f:
            writer=csv.writer(f)
